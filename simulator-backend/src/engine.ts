...
export class MicrogridEngine extends EventEmitter {
  ...
  private initializeHomes(): HomeState[] {
    const configs = [
      { id: "H001", pv: 8.0, batt: 13.5, scale: 1.0, critical: false },
      { id: "H002", pv: 6.5, batt: 10.0, scale: 1.1, critical: false },
      { id: "H003", pv: 7.5, batt: 12.0, scale: 0.9, critical: false },
      { id: "H004", pv: 5.0, batt: 8.0, scale: 1.3, critical: true },
      { id: "H005", pv: 6.0, batt: 10.0, scale: 1.0, critical: false },
      { id: "H006", pv: 4.5, batt: 7.0, scale: 1.4, critical: true },
      { id: "H007", pv: 5.5, batt: 9.0, scale: 1.2, critical: false },
      { id: "H008", pv: 7.0, batt: 11.0, scale: 0.9, critical: false },
      { id: "H009", pv: 3.5, batt: 5.0, scale: 1.5, critical: true },
      { id: "H010", pv: 6.5, batt: 10.5, scale: 1.1, critical: false },
      { id: "H011", pv: 7.0, batt: 11.0, scale: 1.0, critical: false },
      { id: "H012", pv: 5.5, batt: 9.0, scale: 1.2, critical: false },
      { id: "H013", pv: 6.0, batt: 10.0, scale: 1.1, critical: true },
      { id: "H014", pv: 4.0, batt: 6.0, scale: 1.4, critical: false },
      { id: "H015", pv: 7.5, batt: 12.0, scale: 0.9, critical: false },
      { id: "H016", pv: 5.0, batt: 8.0, scale: 1.3, critical: true },
      { id: "H017", pv: 6.5, batt: 10.0, scale: 1.0, critical: false },
      { id: "H018", pv: 8.0, batt: 13.5, scale: 0.8, critical: false },
      { id: "H019", pv: 4.5, batt: 7.0, scale: 1.5, critical: true },
      { id: "H020", pv: 6.0, batt: 10.0, scale: 1.1, critical: false },
    ];
