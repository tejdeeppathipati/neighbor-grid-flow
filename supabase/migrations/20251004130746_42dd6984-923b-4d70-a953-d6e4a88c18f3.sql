...
alter table rollup_daily_home enable row level security;
alter table rollup_daily_community enable row level security;
alter table pool_ledger enable row level security;
alter table sim_events enable row level security;
alter table tariffs enable row level security;
alter table allocation_policies enable row level security;
...
-- Users policies (users can read their own record)
