      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[hsl(var(--surface-2))] items-center justify-center p-12">
        <div className="max-w-md text-center">
          <div className="mb-8 flex justify-center">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[hsl(var(--acc-blue))] to-[hsl(var(--acc-cyan))] flex items-center justify-center">
          ...
          <p className="text-[hsl(var(--text-dim))] text-lg">
            Monitor community energy flows, optimize distribution, and ensure grid resilience.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-[hsl(var(--surface))] rounded-[var(--radius-xl,16px)] shadow-[var(--shadow-card)] p-8 border border-[hsl(var(--border))]">
            <div className="mb-8">
              ...
              <p className="text-[hsl(var(--text-dim))]">For microgrid operators</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="admin@neighborgrid.com"
